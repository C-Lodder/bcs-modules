...
<div id="scores" class="uk-text-center uk-text-bold">
	...
	<p class="uk-h3 uk-margin-top-remove">BCS (<span class="scoreBCS"></span>)<span class="uk-h4 uk-text-muted uk-display-inline-block uk-margin-small-left uk-margin-small-right">vs</span>LnA (<span class="scoreOther"></span>)</p>
</div>
